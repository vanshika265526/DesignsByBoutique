                ...
                <div className="relative flex items-center justify-between h-[72px] md:h-20 gap-2 sm:gap-4">
                    ...
                    <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 text-center px-1 max-w-[52%] sm:max-w-none">
                        <Link href="/" className="inline-flex flex-col items-center group text-center">
                            <h1 className="font-serif-editorial text-[15px] sm:text-lg md:text-xl lg:text-2xl font-black sm:font-bold tracking-[0.005em] sm:tracking-[0.04em] uppercase leading-none whitespace-nowrap">
                            ...
                            <div className="flex items-center gap-0.5 sm:gap-2 mt-1 sm:mt-1">
                                ...
                                <p className="text-[5px] sm:text-[7.5px] md:text-[8px] lg:text-[8.5px] uppercase tracking-[0.1em] sm:tracking-[0.3em] text-[#4A3818] font-bold whitespace-nowrap">
