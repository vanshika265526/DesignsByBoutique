    ...
    return (
        <div className="space-y-6 max-w-5xl">
                ...
                <div className="flex items-center space-x-3 min-w-0">
                    ...
                    <div className="min-w-0">
                        ...
                        <p className="text-xs text-neutral-500">
                            Create a new product listing in your single-source-of-truth catalog
                        </p>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Royal Rose Velvet Zardozi Lehenga"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="e.g. Soft blush rose Chanderi silk Anarkali with Gota Patti embroidery."
                                    className="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-boutique-rose"
                                />
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    placeholder="Describe the fabric, craftsmanship, embroidery, and styling notes..."
                                    className="w-full px-4 py-2.5 bg-neutral-50 border border-neutral-200 rounded-xl text-xs focus:outline-none focus:border-boutique-rose"
                                />
                            </div>
                ...
                {/* Right 1 Col: Category, Chapter, Status & Specs */}
                    ...
                    <div className="bg-white p-6 rounded-2xl border border-neutral-200/80 space-y-4 shadow-2xs">
                        ...
                        <div className="flex space-x-2">
                            <input
                                ...
                                placeholder="e.g. Pure Mulberry Velvet Silk"
            ...
            {/* Live Product Card Preview Modal */}
            {previewModal && (
